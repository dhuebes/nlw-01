...
const CreatePoint = () => {
    ...
    useEffect(() => {
        axios.get<ibgeUF[]>('https://servicodados.ibge.gov.br/api/v1/localidades/estados?orderBy=nome').then(resp => {
    ...
    useEffect(() => {
        if (selectedUF !== '0') {
            axios.get<ibgeCity[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUF}/municipios?orderBy=nome`).then(resp => {
